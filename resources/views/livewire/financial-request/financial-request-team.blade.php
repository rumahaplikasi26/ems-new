<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.financial_request_team'), 'url' => route('team-financial-request.index')]]], key('breadcrumb'))
