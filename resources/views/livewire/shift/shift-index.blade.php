<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Master Data', 'url' => '/'], ['name' => 'Shift', 'url' => route('shift.index')]]], key('breadcrumb'))

    <div class="row">
        <div class="col-lg-12">

            <div class="card" id="form-shift">
                <div class="card-body" wire:ignore>
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h4 class="card-title mb-4">Shift Form</h4>
                        </div>
                    ...
                    <div class="collapse @if ($showForm) show @endif" wire:click="changeStatusForm()"
                        id="showForm">
                        @livewire('shift.shift-form', key('shift-form'))
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg">
            @livewire('shift.shift-list', ['shifts' => $shifts->getCollection()], key('shift-list'))
        ...
        <script>
            $wire.on('collapse-form', () => {
                ...
                if (showForm) {
                    ...
                    $('#name').focus();
                    $('html, body').animate({
                        scrollTop: $('#form-shift').offset().top
