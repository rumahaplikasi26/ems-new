<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.daily_report_team'), 'url' => route('team-daily-report.index')]]], key('breadcrumb'))
