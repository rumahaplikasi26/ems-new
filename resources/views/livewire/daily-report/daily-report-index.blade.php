<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.daily_reports'), 'url' => route('daily-report.all')]]], key('breadcrumb'))
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="input-daterange input-group" id="daily-report-inputgroup"
                ...
                <div class="col-12 text-end mb-3">
                    ...
                    @can('create:daily-report')
                        <a href="{{ route('daily-report.create') }}" class="btn btn-primary mt-2">{{ __('ems.create') }}</a>
                    @endcan
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            @livewire('daily-report.daily-report-list', ['daily_reports' => $daily_reports->items()], key('daily-report-list'))
        </div>
