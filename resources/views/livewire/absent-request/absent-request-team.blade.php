<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.team_absent_request'), 'url' => route('team-absent-request.index')]]], key('breadcrumb'))
