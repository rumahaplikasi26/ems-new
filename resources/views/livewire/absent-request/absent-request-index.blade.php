<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'Absent Request', 'url' => route('absent-request.index')]]], key('breadcrumb'))
            ...
            <div class="row">
                ...
                <div class="col-12 text-end mb-3">
                    ...
                    @can('create:absent-request')
                        <a href="{{ route('absent-request.create') }}" class="btn btn-primary mt-2">Create</a>
                    @endcan
                </div>
            </div>
        </div>
