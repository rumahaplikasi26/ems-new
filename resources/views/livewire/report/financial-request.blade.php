<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'Financial Request', 'url' => route('financial-request.index')]]], key('breadcrumb'))
    ...
    <div class="row">
        <div class="col-lg-12">
            @livewire('report.financial-request-preview', key('preview'))
        </div>
    </div>
