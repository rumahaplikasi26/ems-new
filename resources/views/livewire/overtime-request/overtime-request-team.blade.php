<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.overtime_request_team'), 'url' => route('overtime-request.index')]]], key('breadcrumb'))
