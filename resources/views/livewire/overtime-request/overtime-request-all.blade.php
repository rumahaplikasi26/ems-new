<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.overtime_request_all'), 'url' => route('overtime-request.all')]]], key('breadcrumb'))
