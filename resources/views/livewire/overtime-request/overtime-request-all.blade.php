<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Application', 'url' => '/'], ['name' => 'Overtime Request', 'url' => route('overtime-request.all')]]], key('breadcrumb'))
            ...
            <div class="row">
                ...
                <div class="col-12 text-end mb-3">
                    ...
                    @can('create:overtime-request')
                        <a href="{{ route('overtime-request.create') }}" class="btn btn-primary mt-2">Create</a>
                    @endcan
                </div>
            </div>
        </div>
