<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => __('ems.application'), 'url' => '/'], ['name' => __('ems.overtime_request'), 'url' => route('overtime-request.index')]]], key('breadcrumb'))
            ...
            <div class="row">
                ...
                <div class="col-12 text-end mb-3">
                    ...
                    @can('create:overtime-request')
                        <a href="{{ route('overtime-request.create') }}" class="btn btn-primary mt-2">{{ __('ems.create') }}</a>
                    @endcan
                </div>
            </div>
        </div>
