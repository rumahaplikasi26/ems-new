<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Master Data', 'url' => '/'], ['name' => 'Position', 'url' => route('position.index')]]], key('breadcrumb'))
    ...
    <div class="row">
        <div class="col-lg">
            @livewire('position.position-list', ['positions' => $positions->getCollection()], key('position-list'))
            {{ $positions->links() }}
        </div>
    </div>
