...
class VisitItem extends Component
{
    ...
    {
        $this->employee = $this->visit['employee'];
        $this->checkIn = $this->visit['check_in'];
        $this->checkOut = $this->visit['check_out'];
        $this->duration_string = $this->visit['duration_string'];
        $this->duration = $this->visit['duration'];
    ...
    {
        return view('livewire.visit.visit-item');
    }
}
