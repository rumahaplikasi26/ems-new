...
class OvertimeRequestIndex extends BaseComponent
{
    ...
    public function render()
    {
        ...
        $overtime_requests->where('employee_id', $this->authUser->employee->id);
        $overtime_requests = $overtime_requests->orderBy('created_at', 'desc')->paginate($this->perPage);

        return view('livewire.overtime-request.overtime-request-index', compact('overtime_requests'))->layout('layouts.app', ['title' => 'Overtime Request']);
    }
}
